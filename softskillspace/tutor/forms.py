...
class TutorBookALessonForm(CssForm, forms.ModelForm):
    ...
    subject = forms.ModelChoiceField(
        required=True, queryset=Subject.items.all(), empty_label=None,
    )
...
class TutorSubjectForm(CssForm, forms.ModelForm):
    ...
    widgets = {
        "levels": forms.SelectMultiple(
            attrs={
                ...
                "multiple data-remove-item-button": True,
                "data-position": "bottom",
                "data-max-item-count": 8,
                "data-placeholder": True,
                "data-placeholder-val": "Select Institution Level",
