...
urlpatterns = [
    ...
    path(
        ...
        view=views.TutorPaymentHistoryView.as_view(),
        name='tutor-payment-history',
    ),
    path(
        'subjects/',
        view=views.TutorSubjectListView.as_view(),
        name='subjects',
    ),
    path(
        "delete-tutor-subject/",
        view=views.TutorSubjectDeleteView.as_view(),
        name="tutor-subject-delete",
    ),
]
