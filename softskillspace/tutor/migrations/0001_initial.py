    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_code', models.CharField(blank=True, max_length=70, null=True, verbose_name='Bank name / Sort code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_type', models.CharField(choices=[('nursery school', 'Nursery School'), ('primary school', 'Primary School'), ('high school', 'High School'), ('college', 'College'), ('university', 'University'), ('online', 'Online'), ('other', 'Other')], max_length=50)),
                ('course_taken', models.CharField(max_length=100)),
                ('level', models.CharField(choices=[('college_cert', 'College Cert'), ('certificate', 'Certificate'), ('diploma', 'Diploma'), ('degree', 'Degree'), ('masters', 'Masters'), ('phd', 'PhD')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('levels', models.ManyToManyField(to='subject.InstitutionClassification')),
                ('subject', auto_prefetch.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='subject.subject')),
                ('tutor', auto_prefetch.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='tutor.tutor')),
            ],
            options={
