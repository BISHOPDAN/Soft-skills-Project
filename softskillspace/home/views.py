...
class IndexView(TemplateView):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            messages.success(
                self.request, "You have been added to our Newsletter 🥂.",
            )
        else:
            messages.error(
                self.request, "Email is invalid. Please try again",
            )
    ...
    def form_valid(self, form):
        ...
        messages.success(
            ...
            "Thanks for filling the form. \
                You will be notified when the site is ready",
        )
...
class ProfileUpdateView(LoginRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        messages.success(self.request, "Profiles updated successfully")
...
class ContactUsView(TemplateView):
    ...
    def post(self, request, *args, **Kwargs):
        ...
        # If the last_name part of the form is filled, then it's most likely a
        # bot
        ...
        messages.success(
            ...
            "Soft Skill Space Will get back to you as soon as possible 🥂.")
