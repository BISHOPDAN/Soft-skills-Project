...
class Blog(NamedTimeBasedModel):
    ...
    @property
    def preview(self):
        return Truncator(strip_tags(self.content)).words(50)
    ...
    def image_url(self):
        ...
        """
        blog_image = self.blogimage_set.first()

        if blog_image:
            return blog_image.image.url

        return static("images/avatar/blog_placeholder.png")
